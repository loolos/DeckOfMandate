...
export const messagesEnSecondMandate = {
  ...
  "event.nineYearsWar.desc":
    "Beginning in 1688, the Nine Years' War transformed the League of Augsburg coalition into a prolonged contest over who would set the rules of European balance. Louis XIV's France faced not one front but a connected theater: Rhine fortresses, the Low Countries, naval blockades, Atlantic commerce, and colonial outposts all became part of the same strategic war. Campaign victories could be real yet temporary, while credit, taxation, and administrative stamina often mattered more than a single battle. In game terms, this is a Continued crisis: you may campaign each turn at a Europe-Alert-scaled cost, but delay compounds legitimacy and fiscal pressure.",
