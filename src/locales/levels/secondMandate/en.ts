...
export const messagesEnSecondMandate = {
  ...
  "level.gloryUnderStrain.introBody":
    "The age of expansion is over; now comes the cost. Court ritual, tax pressure, confessional conflict, and coalition diplomacy all push against the crown at once.\n\nCarry your gains into a harder chapter. Stabilize finances, contain internal friction, and survive the wars that follow France's rise.",
