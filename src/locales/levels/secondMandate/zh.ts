...
export const messagesZhSecondMandate = {
  ...
  "event.localWar.desc":
    "17 世纪后期的法兰西经常陷入“大战之间的小战”：莱茵边境、意大利北部与低地周边不断出现围城、突袭与补给线争夺。这类冲突往往规模有限，却会反复消耗财政、拖累军政节奏，并被列强当作测试法国意志的前哨战。机制上：该事件不能用「干预」直接解决；你需在军事冒险与政治让步之间二选一——出兵需支付「floor(欧洲警觉进度/2)」经费（再叠加反法情绪加价），安抚则合法性 -1；且若拖到回合结束，下一回合的经费收入会受到惩罚。",
