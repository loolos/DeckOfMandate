...
export const messagesZhSecondMandate = {
  ...
  "level.gloryUnderStrain.introBody":
    "扩张时代已经过去，代价时代开始了。宫廷开支、税务压力、宗教冲突与同盟外交同时压向王权。\n\n把第一章成果带入更艰难的章节：稳住财政、压住内耗，并撑过法国崛起后不可避免的大战。",
  ...
  "event.versaillesExpenditure.desc": "宫廷排场再次超预算。支付 2 经费，否则财政 -2。",
  ...
  "event.provincialNoncompliance.desc":
    "地方官僚拖延政令。支付 1 经费，否则下一回合抽牌修正 -2。",
  "event.risingGrainPrices.name": "粮价上涨",
  "event.risingGrainPrices.desc": "粮价推动社会不稳。支付 2 经费，否则合法性 -2。",
  "event.taxResistance.name": "税收反弹",
  "event.taxResistance.desc": "地方与社群抵制新税。支付 1 经费或王室干预，否则财政 -1 且合法性 -1。",
  "event.frontierGarrisons.name": "边境驻军消耗",
  "event.frontierGarrisons.desc": "边防驻军持续消耗国库。支付 1 经费，否则财政 -1 且下一回合抽牌受罚。",
  "event.tradeDisruption.name": "海贸受阻",
  "event.tradeDisruption.desc":
    "航路受扰影响施政节奏。支付 1 经费，否则下一回合抽牌修正 -2。",
  "event.courtScandal.name": "宫廷丑闻",
  "event.courtScandal.desc": "宫廷派系丑闻动摇威望。支付 1 经费或王室干预，否则合法性 -2。",
