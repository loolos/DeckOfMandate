...
export const messagesZhSecondMandate = {
  ...
  "event.nineYearsWar.desc":
    "自 1688 年起，奥格斯堡同盟的对抗升级为横跨欧洲的九年战争，其核心不只是战场胜负，更是围绕“欧洲均势”的长期消耗。战线从莱茵与低地延伸到海上航路和殖民据点，迫使各国在军费、信用与行政动员上持续透支。机制上：这是「持续」危机；你可每回合投入与欧洲警觉挂钩的成本发动战役，若长期拖延，将承受合法性回落与财政负担累积。",
