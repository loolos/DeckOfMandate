...
export const messagesZhSecondMandate = {
  ...
  "event.nineYearsWar.desc":
    "自 1688 年起，奥格斯堡同盟的对抗演变为围绕“谁来定义欧洲均势”的长期大战。对路易十四的法国而言，这不是单一战场，而是彼此联动的总体战争：莱茵要塞、尼德兰战线、海上封锁、大西洋贸易与殖民据点互相牵动。即便取得局部胜利，也常难以立刻改写全局；真正决定胜负的往往是税收、信用与行政动员能否长期支撑战争机器。机制上：这是「持续」危机；你可每回合投入与欧洲警觉挂钩的成本发动战役，若长期拖延，将持续累积合法性与财政压力。",
