...
export const messagesZhSecondMandate = {
  ...
  "status.antiFrenchSentiment.history":
    "1670 年代后，法荷战争与反法同盟外交令欧洲对法政策迅速趋于协同，法国国力越高，外部抬价与牵制越强。机制上：当“权力+财政”大于 20 时，所有与「欧洲警觉」相关且需经费解决的事件立刻 +1 费用；其后该总和每再增加满 5 点，费用再 +1。且该状态存在期间，每回合结束都会向抽牌堆加入 1 张「反法遏制」（费用 2；抽到时合法性 -1；打出后直接消除不进弃牌堆）。回到 20 或以下时该状态移除。",
