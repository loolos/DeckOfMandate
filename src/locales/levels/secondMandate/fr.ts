...
export const messagesFrSecondMandate: Record<keyof typeof messagesEnSecondMandate, string> = {
  ...
  "status.antiFrenchSentiment.history":
    "Après le tournant des coalitions des années 1670, la montée en puissance française déclenche une coordination extérieure plus serrée. Mécaniquement : quand Pouvoir+Trésor dépasse 20, chaque tranche complète de +5 augmente de +1 le coût de résolution des événements payés en Financement ; tant que ce statut existe, la fin de chaque tour ajoute aussi 1 carte Endiguement anti-français au deck (coût 2 ; à la pioche : Légitimité -1 ; à l'activation : épurée, pas défaussée). Le statut disparaît quand Pouvoir+Trésor revient à 20 ou moins.",
