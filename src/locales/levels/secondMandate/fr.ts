...
export const messagesFrSecondMandate: Record<keyof typeof messagesEnSecondMandate, string> = {
  ...
  "status.europeAlert.hint":
    "Au début du Chapitre 2, perte immédiate de Pouvoir : -{n} (plancher(Pouvoir actuel / 2)). Le revenu du Trésor baisse par paliers de 2 tours (tours 1-2 : -1, tours 3-4 : -2, tours 5-6 : -3, etc.). Alerte Europe peut aussi ajouter chaque année un événement supplémentaire Garnisons frontalières / Perturbation commerciale.",
