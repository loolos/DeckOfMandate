...
export const messagesZhCore = {
  ...
  "ui.solveFundingOrCrackdown": "支付 {cost} 或使用王室干预",
  ...
  "menu.refit.europeAlertOn": "欧洲警觉：开启（围堵相关事件权重 +1）。",
  ...
  "event.publicUnrest.desc": "面包价与流言挤满街头。仅可用王室干预，否则合法性 -1。",
  ...
  "event.powerVacuum.desc": "总督绕过宫廷自行其是。支付 2 经费或使用王室干预，否则下一年槽位升级为「王权危机」。",
  "event.majorCrisis.name": "王权危机",
  "event.majorCrisis.desc": "仅可用王室干预解决。未处理：合法性 -1，且下一回合抽牌惩罚。",
  ...
  "log.eventCrackdownSolved": "[第 {turn} 年] 槽位 {slot}：以王室干预清除 {event}（已花费 {paid} {funding}）。",
  "log.eventYearEndPenalty.title": "[第 {turn} 年] 年末槽位 {slot}：{event} 未处理。",
  "log.eventYearEndPenalty.effectsLabel": "惩罚：",
  "log.eventPowerVacuumScheduled": "[第 {turn} 年] 年末槽位 {slot}：{event} — 下一年将升级为王权危机。",
