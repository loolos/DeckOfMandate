...
import { ResourceTooltipIcon, ResourceTooltipText } from "./SunkingResourceTooltipText";
import styles from "../../../app/Game.module.css";
import { getSunkingCardArtUrl } from "../logic/cardArt";
  ...
  return (
    <div ref={scrollContainerRef} className={styles.hand}>
      {state.hand.map((id, index) => {
        ...
        const cardArtUrl = getSunkingCardArtUrl(inst.templateId);
