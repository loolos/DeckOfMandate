/**
 * Sun King action-log entry renderers. Registered through
 * `registerCampaignLogEntryRenderer` from this campaign's `registerCampaign.ts`;
 * the framework `ActionLog` component owns only the surrounding chrome.
 */
...
export function renderSunkingLogEntry(e: ActionLogEntry, t: UiTranslator) {
  ...
  switch (e.kind) {
    ...
    case "info": {
      ...
      const hasHistory = Object.prototype.hasOwnProperty.call(sunkingMessagesEn, historyKey);
      return (
        <>
