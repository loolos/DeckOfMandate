...
describe("aiStrategySimulation", () => {
  ...
  it("keeps strategy I standalone chapter-2 benchmark stable", () => {
    ...
    expect(report).toMatchInlineSnapshot(`
      {
        "averageEndTurn": 23.915,
        "averageEndTurnOnLoss": 24.5,
        "averageEndTurnOnWin": 22.779,
        "averageEndingResources": {
          "funding": 0,
          "legitimacy": 10.535,
          "power": 9.29,
    ...
    expect(report).toMatchInlineSnapshot(`
      {
        ...
        "averageChapter2EndTurnOnReached": 19.744,
        "averageChapter2EndTurnOnWin": 25.231,
        "chapter1Losses": 114,
        "chapter1WinRate": 0.43,
        "chapter1Wins": 86,
        "chapter2Losses": 73,
        "chapter2Runs": 86,
        "chapter2WinRateAfterCarryover": 0.1512,
        "chapter2Wins": 13,
    ...
    expect(report).toMatchInlineSnapshot(`
      {
        ...
        "averageChapter3EndTurnOnReached": 7.154,
