...
describe("aiStrategySimulation", () => {
  ...
  it("keeps strategy I standalone chapter-2 benchmark stable", () => {
    ...
    expect(report).toMatchInlineSnapshot(`
      {
        "averageEndTurn": 21.15,
        "averageEndTurnOnLoss": 18.766,
        "averageEndTurnOnWin": 22.642,
        "averageEndingResources": {
          "funding": 0.005,
          "legitimacy": 8.765,
          "power": 5.015,
    ...
    expect(report).toMatchInlineSnapshot(`
      {
        ...
        "averageChapter2EndTurnOnReached": 18.548,
        "averageChapter2EndTurnOnWin": 25.5,
        "chapter1Losses": 169,
        "chapter1WinRate": 0.155,
        "chapter1Wins": 31,
        "chapter2Losses": 25,
        "chapter2Runs": 31,
        "chapter2WinRateAfterCarryover": 0.1935,
        "chapter2Wins": 6,
    ...
    expect(report).toMatchInlineSnapshot(`
      {
        ...
        "averageChapter2EndTurnOnReached": 18.548,
        "averageChapter2EndTurnOnWin": 25.5,
        "averageChapter3EndTurnOnReached": 8.667,
