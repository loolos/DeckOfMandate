...
describe("aiStrategySimulation", () => {
  ...
  it("keeps strategy I standalone chapter-2 benchmark stable", () => {
    ...
    expect(report).toMatchInlineSnapshot(`
      {
        "averageEndTurn": 23.645,
        "averageEndTurnOnLoss": 24.35,
        "averageEndTurnOnWin": 22.651,
        "averageEndingResources": {
          "funding": 0,
          "legitimacy": 11.735,
          "power": 8.995,
  ...
  it("keeps strategy I standalone chapter-3 (main menu) benchmark stable", () => {
    ...
    expect(report).toMatchInlineSnapshot(`
      {
        "averageEndTurn": 17.865,
        "averageEndTurnOnLoss": 11.435,
        "averageEndTurnOnWin": 19.786,
        "averageEndingResources": {
          "funding": 0,
          "legitimacy": 11.205,
          "power": 16.425,
    ...
    expect(report).toMatchInlineSnapshot(`
      {
        ...
        "averageChapter2EndTurnOnReached": 19.919,
        "averageChapter2EndTurnOnWin": 24.941,
        "chapter1Losses": 114,
        "chapter1WinRate": 0.43,
        "chapter1Wins": 86,
        "chapter2Losses": 69,
        "chapter2Runs": 86,
        "chapter2WinRateAfterCarryover": 0.1977,
        "chapter2Wins": 17,
    ...
    expect(report).toMatchInlineSnapshot(`
      {
        ...
        "averageChapter3EndTurnOnReached": 8.118,
