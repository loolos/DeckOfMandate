...
describe("aiStrategySimulation", () => {
  ...
  it("keeps strategy I standalone chapter-2 benchmark stable", () => {
    ...
    expect(report).toMatchInlineSnapshot(`
      {
        "averageEndTurn": 21.66,
        "averageEndTurnOnLoss": 20.068,
        "averageEndTurnOnWin": 22.575,
        "averageEndingResources": {
          "funding": 0.005,
          "legitimacy": 9.36,
          "power": 5.605,
    ...
    expect(report).toMatchInlineSnapshot(`
      {
        ...
        "averageChapter2EndTurnOnReached": 19.176,
        "averageChapter2EndTurnOnWin": 25.4,
        "chapter1Losses": 166,
        "chapter1WinRate": 0.17,
        "chapter1Wins": 34,
        "chapter2Losses": 24,
        "chapter2Runs": 34,
        "chapter2WinRateAfterCarryover": 0.2941,
        "chapter2Wins": 10,
    ...
    expect(report).toMatchInlineSnapshot(`
      {
        ...
        "averageChapter3EndTurnOnReached": 8.4,
