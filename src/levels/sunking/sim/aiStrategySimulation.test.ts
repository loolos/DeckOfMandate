...
describe("aiStrategySimulation", () => {
  ...
  it("keeps the benchmark summary stable for first mandate", () => {
    ...
    expect(report).toMatchInlineSnapshot(`
      {
        "averageEndTurn": 13.965,
        "averageEndTurnOnLoss": 14.693,
        "averageEndTurnOnWin": 13,
  ...
  it("keeps strategy I standalone chapter-2 benchmark stable", () => {
    ...
    expect(report).toMatchInlineSnapshot(`
      {
        "averageEndTurn": 23.695,
        "averageEndTurnOnLoss": 24.469,
        "averageEndTurnOnWin": 22.69,
        "averageEndingResources": {
          "funding": 0,
          "legitimacy": 12.34,
          "power": 9.15,
  ...
  it("keeps strategy I standalone chapter-3 (main menu) benchmark stable", () => {
    ...
    expect(report).toMatchInlineSnapshot(`
      {
        "averageEndTurn": 17.795,
        "averageEndTurnOnLoss": 11.5,
        "averageEndTurnOnWin": 19.783,
        "averageEndingResources": {
          "funding": 0.045,
          "legitimacy": 11.38,
          "power": 16.06,
        ...
        "outcomeBreakdown": {
          ...
          "victoryUtrechtCompromise": 56,
          "victoryUtrechtHabsburg": 93,
        },
        "outcomeBreakdownRates": {
          "defeatLegitimacyBoth": 0,
          "defeatLegitimacyLegitimacy": 0,
          "defeatLegitimacyPower": 0,
          "defeatSuccession": 0.24,
          "other": 0,
          "victoryCalendarNoUtrecht": 0,
          "victorySuccessionTrackCap10": 0.01,
          "victoryUtrechtBourbon": 0.005,
          "victoryUtrechtCompromise": 0.28,
          "victoryUtrechtHabsburg": 0.465,
        },
        "runCount": 200,
        "startMode": "standalone",
        "strategyId": "a-strategy-i",
  ...
  it("keeps strategy I first-to-second campaign benchmark stable", () => {
    ...
    expect(report).toMatchInlineSnapshot(`
      {
        "averageChapter1EndTurn": 13.965,
        "averageChapter2EndTurnOnReached": 19.977,
        "averageChapter2EndTurnOnWin": 25.571,
        "chapter1Losses": 114,
        "chapter1WinRate": 0.43,
        "chapter1Wins": 86,
        "chapter2Losses": 72,
        "chapter2Runs": 86,
        "chapter2WinRateAfterCarryover": 0.1628,
        "chapter2Wins": 14,
    ...
    expect(report).toMatchInlineSnapshot(`
      {
        ...
        "averageChapter3EndTurnOnReached": 7.571,
        ...
        "chapter3OutcomeBreakdownRates": {
          "defeatLegitimacyBoth": 0,
          "defeatLegitimacyLegitimacy": 0.0714,
          "defeatLegitimacyPower": 0,
          "defeatSuccession": 0.9286,
          "other": 0,
          "victoryCalendarNoUtrecht": 0,
          "victorySuccessionTrackCap10": 0,
          "victoryUtrechtBourbon": 0,
