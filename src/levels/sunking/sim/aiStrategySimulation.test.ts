...
describe("aiStrategySimulation", () => {
  ...
  it("keeps the benchmark summary stable for first mandate", () => {
    ...
    expect(report).toMatchInlineSnapshot(`
      {
        "averageEndTurn": 14.36,
        "averageEndTurnOnLoss": 14.833,
        "averageEndTurnOnWin": 12.94,
  ...
  it("keeps strategy I standalone chapter-2 benchmark stable", () => {
    ...
    expect(report).toMatchInlineSnapshot(`
      {
        "averageEndTurn": 22.205,
        "averageEndTurnOnLoss": 21.981,
        "averageEndTurnOnWin": 22.457,
        "averageEndingResources": {
          "funding": 0.055,
          "legitimacy": 9.505,
          "power": 6.46,
  ...
  it("keeps strategy I standalone chapter-3 (main menu) benchmark stable", () => {
    ...
    expect(report).toMatchInlineSnapshot(`
      {
        "averageEndTurn": 15.885,
        "averageEndTurnOnLoss": 10.518,
        "averageEndTurnOnWin": 19.852,
        "averageEndingResources": {
          "funding": 0.14,
          "legitimacy": 11.27,
          "power": 14.51,
        ...
        "outcomeBreakdown": {
          ...
          "victoryUtrechtCompromise": 26,
          "victoryUtrechtHabsburg": 88,
        },
        "outcomeBreakdownRates": {
          "defeatLegitimacyBoth": 0,
          "defeatLegitimacyLegitimacy": 0,
          "defeatLegitimacyPower": 0,
          "defeatSuccession": 0.425,
          "other": 0,
          "victoryCalendarNoUtrecht": 0,
          "victorySuccessionTrackCap10": 0.005,
          "victoryUtrechtBourbon": 0,
          "victoryUtrechtCompromise": 0.13,
          "victoryUtrechtHabsburg": 0.44,
        },
        "runCount": 200,
        "startMode": "standalone",
        "strategyId": "a-strategy-i",
  ...
  it("keeps strategy I first-to-second campaign benchmark stable", () => {
    ...
    expect(report).toMatchInlineSnapshot(`
      {
        "averageChapter1EndTurn": 14.36,
        "averageChapter2EndTurnOnReached": 19.76,
        "averageChapter2EndTurnOnWin": 26,
        "chapter1Losses": 150,
        "chapter1WinRate": 0.25,
        "chapter1Wins": 50,
        "chapter2Losses": 44,
        "chapter2Runs": 50,
        "chapter2WinRateAfterCarryover": 0.12,
        "chapter2Wins": 6,
        "fullCampaignWinRate": 0.03,
        "fullCampaignWins": 6,
        "runCount": 200,
        "strategyId": "a-strategy-i",
      }
    ...
    expect(report).toMatchInlineSnapshot(`
      {
        ...
        "averageChapter3EndTurnOnReached": 7.667,
