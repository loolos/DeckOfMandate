...
describe("aiStrategySimulation", () => {
  ...
  it("keeps strategy I standalone chapter-2 benchmark stable", () => {
    ...
    expect(report).toMatchInlineSnapshot(`
      {
        "averageEndTurn": 21.5,
        "averageEndTurnOnLoss": 19.342,
        "averageEndTurnOnWin": 22.74,
        "averageEndingResources": {
          "funding": 0.005,
          "legitimacy": 8.995,
          "power": 5.285,
  ...
  it("keeps strategy I standalone chapter-3 (main menu) benchmark stable", () => {
    ...
    expect(report).toMatchInlineSnapshot(`
      {
        "averageEndTurn": 18.09,
        "averageEndTurnOnLoss": 11.19,
        "averageEndTurnOnWin": 19.924,
        "averageEndingResources": {
          "funding": 0,
          "legitimacy": 12.64,
          "power": 16.98,
        ...
        "outcomeBreakdown": {
          ...
          "victoryUtrechtCompromise": 94,
          "victoryUtrechtHabsburg": 61,
        },
        "outcomeBreakdownRates": {
          "defeatLegitimacyBoth": 0,
          "defeatLegitimacyLegitimacy": 0,
          "defeatLegitimacyPower": 0,
          "defeatSuccession": 0.21,
          "other": 0,
          "victoryCalendarNoUtrecht": 0,
          "victorySuccessionTrackCap10": 0.005,
          "victoryUtrechtBourbon": 0.01,
          "victoryUtrechtCompromise": 0.47,
          "victoryUtrechtHabsburg": 0.305,
        },
        "runCount": 200,
        "startMode": "standalone",
        "strategyId": "a-strategy-i",
    ...
    expect(report).toMatchInlineSnapshot(`
      {
        ...
        "averageChapter2EndTurnOnReached": 18.941,
        "averageChapter2EndTurnOnWin": 25.286,
        "chapter1Losses": 166,
        "chapter1WinRate": 0.17,
        "chapter1Wins": 34,
        "chapter2Losses": 27,
        "chapter2Runs": 34,
        "chapter2WinRateAfterCarryover": 0.2059,
        "chapter2Wins": 7,
        "fullCampaignWinRate": 0.035,
        "fullCampaignWins": 7,
        "runCount": 200,
        "strategyId": "a-strategy-i",
      }
    ...
    expect(report).toMatchInlineSnapshot(`
      {
        ...
        "averageChapter3EndTurnOnReached": 7.429,
        ...
        "chapter3OutcomeBreakdownRates": {
          "defeatLegitimacyBoth": 0,
          "defeatLegitimacyLegitimacy": 0,
          "defeatLegitimacyPower": 0.1429,
          "defeatSuccession": 0.8571,
          "other": 0,
          "victoryCalendarNoUtrecht": 0,
          "victorySuccessionTrackCap10": 0,
          "victoryUtrechtBourbon": 0,
