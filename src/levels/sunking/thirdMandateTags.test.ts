...
describe("third mandate succession contest tags", () => {
  it("marks all four succession-contest player cards with the successionContest tag", () => {
    ...
    expect(getCardTemplate("usurpationEdict").tags).toContain("successionContest");
  });
});
