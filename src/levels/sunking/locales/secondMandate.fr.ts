...
export const messagesFrSecondMandate: Record<keyof typeof messagesEnSecondMandate, string> = {
  ...
  "level.gloryUnderStrain.name": "Roi-Soleil : Longues ombres à midi",
  "level.gloryUnderStrain.introTitle": "France, 1676 — maintenir l'hégémonie",
  "level.gloryUnderStrain.introBody":
    "La France de 1676 paraît dominante, mais la monarchie entre dans une phase de gouvernement sous haute pression. La guerre de Hollande n'est pas réellement close ; garnisons de frontière, chantiers de places fortes, dépenses de cour et dettes accumulées ponctionnent simultanément le Trésor. Les hausses d'impôts et les réquisitions alimentent en retour les résistances des parlements, des états provinciaux et des communautés taxées. Versailles conserve son éclat, mais le pouvoir royal passe d'une logique de « profits d'expansion » à une logique de « paiement permanent de l'hégémonie ».\n\nLes tensions intérieures sont tout aussi vives. Depuis l'édit de Nantes, l'ordre du royaume reposait sur une coexistence confessionnelle limitée ; sous Louis XIV, surtout dans la seconde partie du règne, la cour associe de plus en plus l'uniformité religieuse à l'obéissance administrative. Réprimer les huguenots peut afficher l'autorité à court terme, mais cela favorise aussi l'exil des compétences, les réseaux clandestins et des coûts policiers durables. La tolérance peut réduire la violence immédiate, tout en provoquant la réaction des courants intransigeants de la cour et de l'Église. Pression fiscale, crises frumentaires et conflit confessionnel se renforcent mutuellement : une rupture locale peut vite devenir une crise générale de légitimité.\n\nLe péril extérieur vient de la consolidation d'une coalition d'équilibre européen. Sur le front des Pays-Bas et de la Flandre, la monarchie prolonge des corridors fortifiés sous garnison et une pression routinière vers les Pays-Bas espagnols et la ceinture frontalière des Provinces-Unies ; sur le Rhin moyen, les juristes de la couronne retravaillent les clauses westphaliennes jusqu'à des coups comme la prise de Strasbourg en 1681, implantant des têtes de pont bourboniennes au cœur du territoire impérial. Parallèlement aux armées de campagne fonctionne une machinerie d'annexion plus discrète : les Chambres de réunion fouillent archives féodales et chaînes successorales pour soutenir que telle ville ou telle seigneurie « appartenait déjà » au roi de France, absorbant parcelles alsaciennes sans déclencher partout une mobilisation générale — tout en rognant néanmoins l'espace du Reich et en étroitissant les voies commerciales dont dépend la Hollande.\n\nLes cours en tirent la même leçon : les concessions bilatérales ne suffiront pas à freiner l'agrandissement bourbon ; seul un endiguement coordonné le peut. La Ligue d'Augsbourg se forme en 1686 ; l'Angleterre, les Provinces-Unies et l'Espagne se rapprochent ensuite de cette coordination. Après la rupture politique anglaise de 1688, les capacités financières et maritimes de l'alliance anti-française se stabilisent et montent en puissance, transformant les frictions frontalières en guerre de Neuf Ans.\n\nDans le même temps, l'ombre de la succession ibérique apparaît déjà : le roi Charles II d'Espagne n'a pas d'héritier survivant, sa lignée paternelle relève des Habsbourg d'Espagne, et sa parenté maternelle est étroitement liée à la maison de Bourbon par des mariages dynastiques répétés. La question successorale madrilène se trouve ainsi liée à la fois à Vienne et à Versailles. Pour les Bourbons, revendiquer la couronne d'Espagne ouvre la perspective d'un bloc dynastique franco-espagnol et d'un redéploiement stratégique en Méditerranée comme dans les Pays-Bas ; pour les Habsbourg d'Autriche, cette couronne relève de l'héritage de leur propre branche familiale, et la laisser passer aux Bourbons signifierait subir une pression française renforcée en Europe et outre-mer. Voilà pourquoi les deux camps traitent le droit de succession espagnol comme un enjeu non négociable.\n\nVotre défi n'est donc pas une bataille isolée, mais une guerre d'usure où fragilités intérieures et encerclement extérieur s'aggravent ensemble : maintenir le centre du pouvoir entre foi, fiscalité, succession dynastique et guerre, et faire tenir la France dans la confrontation générale qui s'annonce.",
  ...
  "event.nobleResentment.desc":
    "La résistance des élites grandit à la cour et en province : payez 2 Financement ou Intervention ; sinon, perdez 1 Pouvoir et subissez Rancune nobiliaire pendant 2 tours.",
  ...
  "event.provincialNoncompliance.desc":
    "Les officiels locaux ralentissent l'application : payez 2 Financement ou subissez Traînage provincial pendant 3 tours plus un second pendant 1 tour : pioche -2 l'an prochain, puis pioche -1 chacune des deux années suivantes.",
  ...
  "event.tradeDisruption.desc":
    "Les risques sur routes maritimes et convois réduisent la marge de gouvernance : payez 1 Financement ou cumulez deux statuts Désordre des routes maritimes pendant 1 tour (pioche -2 l'an prochain).",
  ...
  "event.warWeariness.desc":
    "Le conflit prolongé épuise le soutien : payez 3 Financement ou Intervention, sinon perdez 1 Légitimité et gagnez Épuisement de guerre pour 2 tours.",
