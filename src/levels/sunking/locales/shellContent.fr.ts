...
export const sunkingShellContentFr = {
  ...
  "ui.dualFrontCrisis.concede": "Céder provisoirement — piste −3",
  "ui.dualFrontCrisis.escalate": "Élargir la guerre — piste +1, légitimité −1, +3 Charges fiscales",
  ...
  "ui.opponentEvent.piles": "Pioche adverse : {deck} · Défausse adverse : {discard}",
  ...
  "ui.opponentEvent.lastPlayCardBlurb": "{history} {cost} : {fx}",
  ...
  "outcome.utrechtVictoryEpilogue.bourbon": "Après la série d’Utrecht, le canon cède au parchemin : la puissance bourbonienne ne s’arrête pas aux garde-fous et réunit formellement les couronnes de France et d’Espagne sous un même ordre dynastique. L’Europe fait face à une double-couronne bien plus puissante — tandis que coûts de guerre, pression fiscale et tensions sociales allument peu à peu la mèche d’un futur âge révolutionnaire.",
  ...
  "outcome.successionCalendar1720Extra.bourbon": "En 1720, la guerre ouverte est close par les traités, mais le règlement d’après-guerre conserve l’issue bourbonienne maximale : Philippe V tient le trône d’Espagne, et les couronnes de France et d’Espagne sont intégrées dans un même ordre dynastique. L’Europe fait désormais face à une monarchie bourbonienne à double couronne, franchissant les Pyrénées et reliant la puissance méditerranéenne au système colonial atlantique, tandis que Versailles peut présenter la guerre de succession comme une victoire ayant achevé l’union dynastique.",
