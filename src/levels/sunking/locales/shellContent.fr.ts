...
export const sunkingShellContentFr = {
  ...
  "log.eventLouisXivLegacy.regencyCustody": "[Tour {turn}] {event} — choix « Régence de garde » ; Pouvoir −1, Légitimité −1, et +1 Fardeau fiscal.",
  "log.eventLouisXivLegacy.youngKingDirectRule": "[Tour {turn}] {event} — choix « Gouvernement direct du jeune roi » ; Pouvoir +1, +3 Fardeaux fiscaux, et gain de Doute de minorité.",
