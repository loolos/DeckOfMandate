...
export const sunkingShellContentFr = {
  ...
  "outcome.successionCalendar1720Extra.bourbon": "En 1720, les traités d’Utrecht, de Rastatt et de Baden ont fixé les conditions d’après-guerre : Philippe V reste sur le trône d’Espagne, l’union formelle entre France et Espagne est écartée, et la couronne espagnole demeure dans une branche bourbonienne. Pour la France, ce règlement conserve un résultat présentable devant le royaume tout en reconnaissant les concessions inscrites dans les traités.",
