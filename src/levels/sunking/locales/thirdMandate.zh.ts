...
export const messagesZhThirdMandate = {
  ...
  "level.successionWar.introBody":
    "卡洛斯二世无嗣而崩，西班牙这棵哈布斯堡古树一朝倾倒，地中海与大西洋之间的权力平衡便整体重写。从卡斯提尔、阿拉贡到那不勒斯与米兰，从西属尼德兰到美洲银税——「西班牙王位」从来不只是一顶王冠，而是一整套帝国资源与海洋通道的捆束。法国以波旁联姻与一纸遗嘱的措辞为凭，主张安茹腓力入继马德里的正当性；维也纳与帝国议会则高举哈布斯堡法统与均势，试图框住波旁北进与西向的半径。伦敦与海牙在海峡利益与殖民贸易上彼此借势，又与大同盟诸邦串联，担心凡尔赛的疆域想像越过莱茵与低地。\n\n这场争端并非单线一战可尽：尼德兰与莱茵诸邦上，棱堡与冬营交替；意大利山地与海洋之间，补给、贷款与雇佣兵合同织成绵长的消耗；到乌得勒支诸和前后，地图才被墨水勉强固定。你在本章所经历的，正是法国王权在列强夹击下，如何把财政、声誉与军队投入这场暮阳斜照下的遗冕之争：争夺西班牙遗产与王冠法统的漫漫长局。",
