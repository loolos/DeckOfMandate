...
export const messagesZhThirdMandate = {
  ...
  "level.successionWar.ending.defeatSuccessionTrackFloor":
    "当王位争夺跌至谷底，维也纳档案、海牙汇票与帝国法学家的备忘录汇成同一判决：把法西捆束推上顶峰的设想，已超出欧洲愿意承担的霸权半径。哈布斯堡支系与大同盟叙事把奥地利的候选资格、对遗嘱的质疑乃至分割方案抬进公法的主流；补贴、帝国禁令与战场上的失血，则把纸面法统翻译成各国宫廷可共同签字的结论——法国可以在西班牙押上全部声望与财政，却再也拿不到写结局的那支笔。",
