...
export const messagesZhThirdMandate = {
  ...
  "level.successionWar.ending.victory":
    "战火熄入文书之后，法国并未赢得一张毫无代价的欧陆地图，却保住了王朝叙事与国家机器的连续性：你让凡尔赛在疲惫与猜忌中仍能发号施令，把“还能执政”本身变成了这场长期战争里最硬的胜利。",
  "level.successionWar.ending.victoryByTier.bourbon":
    "波旁档位的和约账本向你倾斜：马德里留在波旁叙事之内，凡尔赛得以把血与银的消耗折算成可对内外辩护的王朝收益。欧洲仍以条款防着“法西合一”，但终章的署名权已明显偏向你的宫廷。",
  "level.successionWar.ending.victoryByTier.compromise":
    "【史实向】乌得勒支—拉斯塔特—巴登这一组和约没有给出单方凯旋：欧洲承认费利佩五世留驻马德里，同时用放弃继承、边界重划、海上与贸易条款锁死法西合并风险。你的结局因此不是“征服欧陆”，而是把可签字、可执行、可持续的均势秩序维持到最后一页。",
  "level.successionWar.ending.victoryByTier.habsburg":
    "哈布斯堡占优档意味着你赢得的是“避免最坏”而非“取得最好”：法国仍保住了体面退场与部分筹码，却被更紧的边界、法统与海权条款套上缰绳。这是一份带着胜利标题、却处处写着代价注脚的终章。",
  "level.successionWar.ending.victoryWarDevolutionExtra":
    "早年对外攻势仍影响邻国的读法，但审慎外交抑制了最坏的连锁反应。",
  "level.successionWar.ending.defeat":
    "你没能把继承战争收束为秩序，反而让它反噬国家中枢：财政见底、军政失序、朝廷互相甩责。到结局落笔时，法国失去的不只是筹码，更是让欧洲相信其仍可稳定执政的能力。",
  "level.successionWar.ending.victorySuccessionTrackCap":
    "王冠之争终见分晓：波旁的血脉与法兰西的声威，在遗嘱、疆场与外交的烈火中淬炼成不可辩驳的胜利。安茹亲王入主马德里不再是悬而未决的赌注，而是昭告天下的天命所归——从地中海的帆影到莱茵的营火，欧罗巴的嫉妒与联盟终将在你的凯旋叙事前俯首。这是太阳王治下最辉煌的一页：西班牙的遗产与波旁的冠冕合而为一，千秋史册将用金墨记下这一刻。",
