...
export const sunkingCoreGameContentZh = {
  ...
  "status.grandAllianceInfiltration.history": "渗透外交削弱了同盟协调，本年末对手阶段预算降低。",
  ...
  "status.greatPowerEncirclement.history":
    "在西班牙王位继承战争中，凡尔赛的扩张势头与波旁王朝的继承布局，被欧洲多国视为权力失衡信号。英国、荷兰、萨伏依与葡萄牙因此向哈布斯堡持续输送财政、海军与陆军协同支持，把局部战场推向更广泛的围堵格局。机制：第三关中，哈布斯堡对手行存在且财政、权力、合法性合计超过 50 时获得此状态并使对手实力 +1；若合计超过 75，该状态会再额外使对手实力 +1（每场战争一次）。只要乌德勒支和约尚未终结战争，这股外援就会持续抬高哈布斯堡阵营的作战能力。",
  ...
  "status.bourbonMarriageRetention.history":
    "以联姻与继承法理为公开叙事，短期内稳住文书与廷议节奏；手牌总上限 +1（可高于 12），且与合法性叠加入年末可保留张数。",
