...
export const messagesZhSecondMandate = {
  ...
  "level.gloryUnderStrain.introBody":
    "1676 年的法国看似强盛，实则进入高压统治期。法荷战争尚未真正收束，边境驻军、要塞工程、宫廷开支与旧债同时吞噬国库；加税与征发又不断触发地方高等法院、省议会与纳税社群的消极抵制。凡尔赛的威仪仍在，但王权已从“扩张获利”转向“为既有霸权持续付费”。\n\n内忧同样尖锐。自《南特敕令》以来，法国依靠有限宗教共存维持秩序；到路易十四中后期，朝廷愈发把宗教整齐划一与行政服从绑定。对胡格诺派的压制在短期能展示控制力，却会带来人才外流、地下聚会网络与长期治安成本；若放宽，又会遭遇宫廷与教会中的强硬派反弹。税负、粮价与宗派冲突彼此叠加，任何一次地方失序都可能迅速演变成全国性的合法性危机。\n\n外患则来自欧洲均势的成形。法国在低地、莱茵与“合并裁决厅（Réunions）”上的持续推进，让周边国家逐步形成“必须联合遏制波旁”的共识。1686 年奥格斯堡同盟建立后，英格兰、荷兰与西班牙进一步靠拢；1688 年英格兰政局剧变使反法联盟获得更稳固的财政与海上动员能力，冲突遂从边境摩擦升级为九年战争。\n\n与此同时，伊比利亚王位继承的阴影已经浮现：西班牙国王卡洛斯二世本人没有子嗣，而其父系属于西班牙哈布斯堡，母系又与法国波旁王室长期通婚，导致马德里宫廷在“血统合法性”上同时牵连维也纳与凡尔赛。对波旁而言，宣称西班牙王位意味着打通法西两大王冠的王朝前景、重塑地中海与低地战略纵深；对奥地利哈布斯堡而言，西班牙王位原本就出自同一家族分支，若旁落波旁，帝国将面临法兰西在欧陆与海外的双重挤压。正因如此，双方都把“谁有资格继承西班牙”视作不可退让的核心议题。\n\n你要面对的，不只是单场战役，而是内政脆弱与外部围堵同步加深的持久消耗战：在信仰、税赋、王朝继承与战争之间守住统治中枢，让法国撑过即将到来的全面对抗。",
