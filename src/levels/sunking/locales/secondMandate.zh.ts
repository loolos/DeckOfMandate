...
export const messagesZhSecondMandate = {
  "level.gloryUnderStrain.name": "烈日长影",
  ...
  "event.nymwegenSettlement.desc":
    "1678—1679 年的《奈梅亨和约》结束了法荷战争主战阶段：法国巩固了在法兰德斯与弗朗什孔泰的部分成果，也暂时缓和了多线作战压力；但欧洲诸国对路易十四扩张意图的警惕并未消失，反而在和约后继续演化为更持久的“均势防法”逻辑。机制上，这是需要尽快收束的长期事件：支付「欧洲警觉进度 + 3」经费可达成和约（权力 -2、财政 -1、合法性 -1），但不会结束「欧洲警觉」；若不处理，每年权力 -1。",
  "event.revocationNantes.name": "处理南特敕令",
  "event.revocationNantes.desc":
    "1598 年，亨利四世在长期宗教内战后颁布《南特敕令》，其核心不是宗教平等，而是一种“可治理的停火”：法国仍以天主教为国教，但胡格诺派获得有限礼拜权、部分司法保障与若干军事安全据点。17 世纪中后期，王权转向强调信仰与政治秩序的统一，地方教会改革、税务征收、边境安全与对外战争压力彼此叠加，使朝廷越来越把新教社群视为潜在的行政与安全风险。1685 年的撤销标志着这一妥协终结：大量胡格诺派流亡英格兰、荷兰、勃兰登堡与瑞士，法国也失去一部分熟练工匠、商贸网络与金融联系；留在境内者则转入地下聚会与秘密互助，令后续镇压与治理成本长期化。机制简述：本事件若不处理会持续造成抽牌惩罚；「宽容」路线会降低立刻冲突，但后续更容易反复出现宗派争端事件；「镇压」路线则会得到更强控制工具，但要长期应对地下网络反弹与额外治理负担。",
  "event.leagueOfAugsburg.name": "奥格斯堡同盟形成",
  "event.leagueOfAugsburg.desc":
    "1680 年代后，法国在莱茵边境与低地的扩张引发周边长期恐慌。凡尔赛并非被动旁观：朝廷惯用「合并」（Réunions）裁决厅把阿尔萨斯—洛林一线与斯特拉斯堡等战略要地以法律—行政手段并入版图，又在莱茵两岸维持驻军、召回使节、以年金与恐吓并用拉拢或敲打帝国选侯与自由市，试图在帝国宪政缝隙里制造既成事实、迟滞邻国的联合反应；撤销南特敕令后的宗教强硬姿态，则让荷兰与北德意志新教诸侯把「领土蚕食」与「信仰高压」读成同一威胁。1686 年，神圣罗马帝国诸侯、哈布斯堡与德意志诸邦在奥格斯堡结盟，随后英格兰、荷兰与西班牙也逐步向反法协同靠拢——同盟既是对法国上述介入的集体回应，也迫使凡尔赛把「拆解包围」当成必须用年金、秘密外交与边境机动反复支付的长期课题。对路易十四而言，这不只是一次外交摩擦，而是“欧洲均势”开始以制度化同盟约束法国。机制上：这是一个需要累计处理多次的持续外交压力，标记「剩余 3」——必须累计处理 3 次才会彻底从棋盘移除。若当回合不处理，回合末立即权力 -1、财政 -1（不消耗剩余次数）。每次支付 2 经费即算一次处理（不可用干预）：当回合规避惩罚，但事件仍会保留到下回合，直到「剩余」归零。",
  "event.nineYearsWar.name": "九年战争",
  "event.nineYearsWar.desc":
    "自 1688 年起，奥格斯堡同盟的对抗升级为横跨欧洲的九年战争，其核心不只是战场胜负，更是围绕“欧洲均势”的长期消耗。战线从莱茵与低地延伸到海上航路和殖民据点，迫使各国在军费、信用与行政动员上持续透支。机制上：这是「持续」危机；每回合须支付与欧洲警觉进度相关的经费发动战役（另含固定加价；不可用干预），若长期拖延，将承受合法性回落与财政负担累积。",
  ...
  "event.versaillesExpenditure.desc":
    "年金、官职买卖与宫苑工程在路易十四朝持续挤占常轨岁入。宫廷排场再次超预算。支付 3 经费（或干预），否则财政 -2。",
  "event.nobleResentment.name": "贵族怨气",
  "event.nobleResentment.desc":
    "大贵族对削兵权、加税审计尤为敏感，常联想到马扎然时期的财政反弹。宫廷与地方精英抵触情绪升高。支付 2 经费或干预，否则权力 -1 并获得「权力流失」2 回合。",
  "event.provincialNoncompliance.name": "地方消极执行",
  "event.provincialNoncompliance.desc":
    "高等法院与省三级会议仍以特许与免税权牵制督办。地方官僚拖延政令。支付 2 经费，否则下一年抽牌 -2，之后两年每年抽牌 -1。",
  "event.risingGrainPrices.name": "粮价上涨",
  "event.risingGrainPrices.desc":
    "歉收叠加王室粮食政策时，面包骚乱数日即可转为政治危机。粮价推动社会不稳。支付 3 经费（或干预），否则合法性 -2。",
  ...
  "event.embargoCoalition.desc":
    "大同盟海上力量长期以封锁与关税联动施压法国商船。海上限制与关税协同压迫法国贸易。支付 ⌊财政/8⌋+1 经费，或使用王室干预/外交干预处理；成功解决时，若欧洲警觉生效则其进度 -1。若不处理：财政 -1 且下一回合抽牌受罚。",
  ...
  "event.localWar.desc":
    "17 世纪后期的法兰西经常陷入“大战之间的小战”：莱茵边境、意大利北部与低地周边不断出现围城、突袭与补给线争夺。这类冲突往往规模有限，却会反复消耗财政、拖累军政节奏，并被列强当作测试法国意志的前哨战。机制上：你可用「干预」直接解决；若不使用干预，仍可在军事冒险与政治让步之间二选一——出兵需支付与欧洲警觉进度相关的经费（可能叠加反法情绪加价），结果按等概率三分：1/3 局部胜利（权力 +1、合法性 +1）、1/3 僵持（无变化）、1/3 小败（权力 -1）；安抚则合法性 -1；若拖到回合结束，下一回合的经费收入将被减 2（最低 0）。",
  "event.courtScandal.name": "宫廷丑闻",
  "event.courtScandal.desc":
    "凡尔赛的寝宫政治与大臣倾轧常迅速外溢为小册子与街谈巷议。宫廷派系丑闻动摇威望。支付 3 经费处理；若不处理，立刻合法性 -1，且下一回合无法打出王室牌。",
  ...
  "event.warWeariness.desc":
    "九年战争后期，即便前线报捷也难掩国内的财政与人力透支。长期战争削弱民意与服从。支付 3 经费或干预，否则合法性 -1 并获得「权力流失」2 回合。",
  "event.jesuitPatronage.name": "耶稣会庇护",
  "event.jesuitPatronage.desc":
    "1675 年起拉雪兹等耶稣会士贴近王权；精英学院培养官员并常为反詹森派阵地，亦加剧宗教派系紧张。支付 2 经费：向抽牌堆加入 2 张「耶稣会学院」（费用 2，剩余 1/1，合法性 +1；打出时立刻解决一次未解决的「詹森派争议」）与 1 张「宗教矛盾」。不处理无惩罚。",
  "event.expansionRemembered.name": "扩张余震",
  "event.expansionRemembered.desc":
    "邻国档案仍把遗产战争、法荷战争中的法国获利计入长期制衡。早年的强势扩张余波未散。支付 2 经费可压制风险并向抽牌堆加入 2 张「财政负担」；若不处理，则加入 3 张「财政负担」。",
