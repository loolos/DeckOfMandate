...
export const messagesZhSecondMandate = {
  ...
  "event.nobleResentment.desc":
    "大贵族对削兵权、加税审计尤为敏感，常联想到马扎然时期的财政反弹。宫廷与地方精英抵触情绪升高。支付 2 经费或干预，否则获得「权力流失」3 回合。",
  ...
  "event.localWar.desc":
    "17 世纪后期的法兰西经常陷入“大战之间的小战”：莱茵边境、意大利北部与低地周边不断出现围城、突袭与补给线争夺。这类冲突往往规模有限，却会反复消耗财政、拖累军政节奏，并被列强当作测试法国意志的前哨战。机制上：该事件不能用「干预」直接解决；你需在军事冒险与政治让步之间二选一——出兵需支付与欧洲警觉进度相关的经费（可能叠加反法情绪加价），结果按等概率三分：1/3 局部胜利（权力 +1、合法性 +1）、1/3 僵持（无变化）、1/3 小败（权力 -1）；安抚则合法性 -1；若拖到回合结束，下一回合的经费收入将被减 2（最低 0）。",
  ...
  "card.diplomaticCongress.desc": "权力 +1。向手牌加入 1 张「外交干预」。",
