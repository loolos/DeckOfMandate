...
export const messagesEnFirstMandate = {
  ...
  "level.risingSun.introBody":
    "Wind the clock back centuries: Capetian kings slowly assembled France, but authority was always contested among crown lands, nobles, and chartered towns. The Hundred Years' War and later the Italian and Religious wars left deep fiscal and political fractures that the Bourbons inherited rather than solved.\n\nIn 1661, after Mazarin's death, the twenty-three-year-old Louis XIV declared personal rule and refused a new first minister. France was emerging from the Fronde and prolonged war finance: royal authority looked strong in principle, yet provincial privilege, debt, and tax resistance still limited what Paris could actually enforce.\n\nFor the Bourbons, this was both advantage and risk. Since Henry IV, they had rebuilt order, expanded central power, and raised France's diplomatic weight; but that prestige came with a structural burden to keep fiscal-military mobilization running while containing noble and provincial centrifugal pressure.\n\nSo chapter one starts in a \"rising but not yet secure\" moment: consolidate the royal center, fund court-state machinery, and keep domestic order under strain. Abroad, frontier disputes around the Spanish Netherlands will soon become the War of Devolution and sharpen coordinated resistance to Bourbon expansion. Your task is not to enjoy finished hegemony, but to build it before it cracks.",
