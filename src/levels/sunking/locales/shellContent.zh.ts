...
export const sunkingShellContentZh = {
  ...
  "ui.dualFrontCrisis.concede": "暂时让步 — 王位争夺进度 −3；对手实力 +1",
  "ui.dualFrontCrisis.escalate": "扩大战争 — 王位争夺进度 +1，合法性 −1，向抽牌堆加入 3 张财政负担；对手实力 +1",
  ...
  "ui.opponentEvent.piles": "抽牌堆：{deck} · 弃牌堆：{discard}",
  ...
  "outcome.successionCalendar1720Extra.bourbon": "到 1720 年，公开战事已经被条约收束，但战后安排保留了波旁方案的最高成果：费利佩五世稳坐西班牙王位，法兰西与西班牙两顶王冠被纳入同一王朝统序。欧洲由此面对一个跨越比利牛斯、连接地中海与大西洋殖民体系的双冠波旁君主国，凡尔赛也得以把继承战解释为一次完成王朝合并的胜利。",
  ...
  "log.effect.modOpponentStrength": "哈布斯堡对手实力 {delta}",
  "log.opponentHabsburgPlay.title": "[第 {turn} 年] 哈布斯堡阶段：打出合计 {cost} 点对手实力（已减免 {discount}）。",
  ...
  "log.eventDualFrontCrisis.concede": "[第 {turn} 年] {event} — 选择暂时让步；王位争夺进度 −3；对手实力 +1。",
  "log.eventDualFrontCrisis.escalate": "[第 {turn} 年] {event} — 选择扩大战争；王位争夺进度 +1，合法性 −1，向抽牌堆加入 3 张财政负担；对手实力 +1。",
