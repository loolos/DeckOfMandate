...
export const sunkingShellContentZh = {
  ...
  "log.eventLouisXivLegacy.regencyCustody": "[第 {turn} 年] {event} — 选择「摄政监国」；权力 −1、合法性 −1，并向抽牌堆加入 1 张财政负担。",
  "log.eventLouisXivLegacy.youngKingDirectRule": "[第 {turn} 年] {event} — 选择「少主亲政」；权力 +1，并向抽牌堆加入 3 张财政负担，获得「主少国疑」。",
