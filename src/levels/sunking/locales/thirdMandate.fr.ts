...
export const messagesFrThirdMandate = {
  ...
  "level.successionWar.ending.defeat":
    "La crise de succession submerge le régime. Les ressources s’effondrent, la légitimité se fissure et la France paie le prix de l’emportement.",
  ...
  "level.successionWar.ending.defeatSuccessionTrackFloor":
    "Dans la chancellerie de Vienne, à La Haye et chez les juristes du Reich, la lecture habsbourgeoise de l’héritage espagnol absorbe le théâtre testamentaire bourbon. Subsides, bans impériaux et années dures sur le Rhin et dans les Pays-Bas transforment l’effondrement de la piste en verdict partagé : la France ne peut imposer le testament de Charles II sans céder à l’étranger tant de primauté—partitions, candidature autrichienne, garanties protestantes—que Versailles perd la plume qui écrit la paix, avant même les traités.",
