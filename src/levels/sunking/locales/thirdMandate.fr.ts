/**
 * Textes FR pour le niveau `thirdMandate` (guerre de Succession d’Espagne).
 */
export const messagesFrThirdMandate = {
  "level.successionWar.name": "Soleil couchant, couronne vacante",
  "level.successionWar.introTitle": "1701 — Au soleil déclinant : testaments, couronnes et longue guerre",
  "level.successionWar.introBody":
    "Avec la mort de Charles II sans héritier, l’arbre des Habsbourg espagnols s’éteint et toute l’Europe recompose la carte. De Castille aux Pays-Bas méridionaux, de Naples aux routes de l’argent américain, le « trône d’Espagne » n’est pas seulement une couronne : c’est un faisceau de ressources impériales et maritimes. Au cœur du parti bourbon se trouve Philippe, duc d’Anjou—petit-fils de Louis XIV (fils du Grand Dauphin Louis)—qui régnerait en Espagne sous le nom de Philippe V s’il montait sur le trône. Versailles invoque ce lien de grand-père à petit-fils, de longues alliances matrimoniales bourbonnes et le testament du défunt ; Vienne et la Cour impériale invoquent la continuité habsbourgeoise et la peur d’un cernement bourbon. Londres et La Haye, jalouses de la Manche et du commerce, se rangent à des coalitions qui doivent contenir Versailles sans sacrifier leurs propires empires marchands.\n\nCe qui s’ensuit tient moins d’une guerre unique que d’un réseau mobile de fronts : places fortes et négociateurs dans les Pays-Bas espagnols, passages alpins entre Piémont et Rhin, principautés rhénanes écrasées entre armées françaises et impériales, et arithmétique navale des colonies. Les traités d’Utrecht tenteront de fixer durablement la carte ; ce chapitre est la longue traction où la monarchie française étire tribut, fiscalité et prestige sous l’envie des autres couronnes.",
  "level.successionWar.ending.victory":
    "Quand les canons cèdent aux clauses, la France n’obtient pas une carte sans coût — mais elle préserve la continuité dynastique et l’appareil d’État. Dans une guerre d’usure, finir en restant gouvernable est déjà une victoire durement acquise.",
  "level.successionWar.ending.victoryByTier.bourbon":
    "Au palier bourbon, le bilan des traités vous est favorable : Madrid reste dans l’orbite dynastique bourbonienne, et Versailles peut convertir l’usure de guerre en gain politique défendable, malgré les garde-fous anti-union.",
  "level.successionWar.ending.victoryByTier.compromise":
    "Compromis conforme à l’axe historique : Utrecht–Rastatt–Baden ne consacre pas un hégémon unique. Philippe V reste à Madrid, tandis que renonciations, réajustements frontaliers et clauses maritimes-commerciales verrouillent le risque d’union franco-espagnole. Votre fin n’est pas une domination, mais un équilibre signé et exécutoire.",
  "level.successionWar.ending.victoryByTier.habsburg":
    "Au palier favorable aux Habsbourg, vous gagnez surtout en évitant le pire : la France conserve une place, mais sous des contraintes accrues sur frontières, mers et latitude dynastique. Le titre dit victoire ; les clauses racontent le coût.",
  ...
  "level.successionWar.ending.defeat":
    "Vous n’avez pas transformé la guerre de succession en ordre durable : trésor, légitimité et conduite de l’État se défont ensemble. À la dernière ligne, la France perd plus que des positions — elle perd la crédibilité d’un pouvoir encore capable de stabiliser l’Europe.",
  "level.successionWar.ending.victorySuccessionTrackCap":
    "Le combat des couronnes s’achève dans l’éclat : le droit bourbon et la grandeur française, forgés dans les testaments, l’acier et la plume des ambassades, s’imposent comme un triomphe sans réplique. Philippe d’Anjou à Madrid n’est plus un pari mais une proclamation portée par le soleil — jalousies et ligues, de la Manche à la Méditerranée, s’inclinent devant votre marche de victoire. C’est l’heure du Roi-Soleil au zénith : l’héritage d’Espagne et le diadème bourbon ne font plus qu’un, et l’histoire retiendra ce jour en lettres d’or.",
  "level.successionWar.ending.defeatSuccessionTrackFloor":
    "Au plancher de la piste, l’initiative a changé de mains : argumentaire viennois, pression financière et maritime de La Haye et de Londres, et sécurité impériale convergent en grammaire commune défavorable à Versailles. La France peut encore plaider ; elle n’écrit plus le règlement. Cette défaite est territoriale, mais aussi narrative.",

  "event.successionCrisis.name": "Crise de succession",
  "event.successionCrisis.desc":
    "À la mort de Charles II sans héritier, la ligne des Habsbourg espagnols s’éteint : l’Europe doit rattacher ce grand composite — cœurs castillan et aragonais, satellites italiens, Pays-Bas méridionaux, argent américain — à un successeur crédible. Versailles revendique l’héritage pour Philippe d’Anjou en invoquant des alliances de longue date et le testament du défunt, tout en promettant aux cours voisines de ne pas fusionner immédiatement les deux monarchies. Vienne et la branche autrichienne des Habsbourg plaident droits féminins, partages anciens et crainte d’une mainmise française sur la Méditerranée occidentale et les routes coloniales ; elles charrient alliances impériales et coalitions maritimes. Chaque camp aligne juristes et généalogistes pour prouver son titre, et la guerre de papier préfigure la guerre de cabinets et de campagnes.\n\nPayez 3 Fonds pour affirmer une prétention Bourbon plus forte (+1 sur la piste), ou refusez et commencez à −1. Si ignoré jusqu’en fin d’année, compte comme refus (−1) et l’adversaire Habsbourg apparaît quand même.",
  "event.opponentHabsburg.name": "Adversaire : camp des Habsbourg",
  "event.opponentHabsburg.desc":
    "De Vienne aux juristes de Madrid, catholiques convaincus et pragmatiques du Saint-Empire tissent une contre-légitimité aux prétentions bourbonnes—textes, prestige impérial et peur du encadrement français. Cette ligne représente chaque année la pression diplomatique et militaire de ce camp ; la main adverse symbolise les moyens de pression encore disponibles.",
