...
export const messagesFrFirstMandate: Record<keyof typeof messagesEnFirstMandate, string> = {
  ...
  "level.risingSun.introBody":
    "Si l'on remonte le temps de plusieurs siècles : les Capétiens ont progressivement rassemblé la France, mais le domaine royal, les grands féodaux et les villes aux chartes ont sans cesse renégocié l'autorité réelle sur le terrain. La guerre de Cent Ans dévasta les campagnes tout en rendant plus plausible l'idée qu'une couronne plus exigeante devait défendre l'unité du royaume. Les guerres d'Italie puis les guerres de Religion ont pris la France des derniers Valois dans une tension entre ambition continentale et guerre civile, laissant à la lignée bourbonienne d'Henri IV, à l'aube du XVIIe siècle, des dettes politiques et militaires encore loin d'être soldées.\n\nEn 1661, après la mort du cardinal Mazarin — diplomate italien successeur de Richelieu comme principal ministre, qui dirigea la guerre, les finances et la diplomatie françaises pendant la minorité de Louis XIV —, Louis XIV, âgé de vingt-trois ans, annonce son gouvernement personnel et refuse de nommer un nouveau premier ministre. La France sort alors des secousses de la Fronde et de longues décennies de finances de guerre : la couronne domine les grands en théorie, mais doit encore composer avec privilèges provinciaux, dettes accumulées et résistances fiscales. Le royaume est déjà l'un des plus vastes d'Europe par sa population et son potentiel de recettes, mais la capacité de l'État reste inégale et coûteuse à imposer hors du centre.\n\nPour la dynastie bourbonienne, c'est un moment à la fois favorable et périlleux. Depuis l'avènement d'Henri IV en 1589, les Bourbons ont reconstruit l'ordre après les guerres de Religion, renforcé la centralisation sous Louis XIII et Richelieu, puis accru le poids diplomatique français à la fin de la guerre de Trente Ans. À l'époque de l'accession de Louis XIV, la maison de Bourbon hérite non seulement d'un prestige de grande monarchie catholique, mais aussi d'une contrainte structurelle : maintenir la mobilisation fiscale et militaire tout en contenant les forces de dispersion nobiliaires et provinciales.\n\nCe premier chapitre s'ouvre donc sur une phase de « montée sans consolidation achevée ». Vous devez renforcer le centre royal et l'appareil administratif, tout en arbitrant les coûts de fiscalité, de cour et d'armée. À l'extérieur, les litiges autour des Pays-Bas espagnols et de l'ordre frontalier conduiront rapidement à la guerre de Dévolution et susciteront une vigilance coordonnée contre l'expansion bourbonienne. Votre objectif n'est pas d'administrer une hégémonie déjà acquise, mais de la construire avant qu'elle ne se fissure.",
