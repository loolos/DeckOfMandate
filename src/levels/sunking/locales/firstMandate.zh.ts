...
export const messagesZhFirstMandate = {
  ...
  "level.risingSun.introBody":
    "若把时间往回拉长数百年：卡佩诸王在中世纪逐步拼接法兰西版图，却始终要在王室领地、诸侯封地与城市特许之间周旋；百年战争重创乡土，却也倒逼后世君王以更强势的征税与常备逻辑捍卫「王国一体」；随后的意大利争霸与宗教战争，又把瓦卢瓦末期的法兰西拖入对外野心与国内厮杀的双重透支——直到十六世纪末波旁继位时，这笔尚未轧平的军政财政账目，仍旧压在王朝肩头。\n\n1661 年，枢机主教马扎然——出身意大利的外交家，黎塞留之后的王室首席大臣，在路易十四幼年时代实际掌舵军政外交——去世后，23 岁的路易十四宣布亲政，不再任命首席大臣。法国刚走出投石党之乱与长期战争财政的余震：王权在名义上高于诸侯，却仍要与地方特权、债务负担和征税阻力持续博弈。此时的法国已是欧洲人口最多、税源最广的王国之一，但国家机器并不均质，中央命令在各省落实的成本仍然很高。\n\n波旁家族在这一阶段拥有最有利也最危险的地位。自亨利四世于 1589 年建立波旁王朝以来，王室通过《南特敕令》后的秩序重建、路易十三与黎塞留时期的集权推进，以及三十年战争末期的外交胜势，逐步把法国推向欧陆核心。到路易十四登基时代，波旁王朝既继承了“天主教最强君主国”的政治资本，也继承了必须持续动员财政与军队、压住贵族与地方离心的结构性压力。\n\n你的第一关，正是这段“上升但未稳固”的开端：一边重塑王权中枢与官僚执行，一边处理税赋、宫廷与军费的现实约束；对外，围绕西属尼德兰与边境秩序的争端将很快引向遗产战争，并触发欧洲列强对波旁扩张的联合警惕。你要做的不是享用既得霸权，而是在它真正成形之前把法国撑住。",
