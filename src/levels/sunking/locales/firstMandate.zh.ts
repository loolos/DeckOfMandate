...
export const messagesZhFirstMandate = {
  ...
  "event.warOfDevolution.history":
    "1667 年，路易十四以王后玛丽·泰蕾兹的继承权为名，对西属尼德兰与弗朗什孔泰提出“遗产权”主张并发动战争。法军在沃邦式攻城体系与后勤组织支持下推进迅速，迫使西班牙在 1668 年接受《亚琛和约》，法国取得多座边境要塞，但这场速胜也直接刺激英格兰、荷兰与瑞典结成三国同盟，欧洲开始更系统地制衡法国扩张。",
  "event.warOfDevolution.desc":
    "可选择发动攻势获取阶段收益，但会提高后续反法协同压力；若不进攻，该议题会持续占位到 1669 年。",
