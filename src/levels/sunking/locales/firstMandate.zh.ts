...
export const messagesZhFirstMandate = {
  ...
  "level.risingSun.introBody":
    "回望数百年，卡佩王朝逐步拼合了法兰西，但王室始终要与诸侯、地方特权和城市自治反复博弈。百年战争、意大利战争与宗教战争留下了沉重的财政与治理后遗症，波旁继位时这笔账并未真正清零。\n\n1661 年马扎然去世后，23 岁的路易十四宣布亲政，不再设首席大臣。法国虽已走出投石党与长期军费危机的高峰，却仍被债务、税阻与地方执行成本牵制；王权“在原则上更强”，国家能力却尚未均衡落地。\n\n对波旁而言，这是强势与脆弱并存的节点。自亨利四世以来，王朝通过秩序重建、集权推进与外交胜势跻身欧陆中心，但也被迫长期维持财政—军事实动员，以压住贵族与省区离心。\n\n第一关正从这段“上升但未稳固”的时刻开始：你要在内政上强化王权中枢与行政执行，平衡税赋、宫廷与军费；在外交上，应对围绕西属尼德兰的争端如何滑向遗产战争，并承受列强对波旁扩张的联合警惕。你的任务不是享受霸权，而是在它成形前先把法国稳住。",
