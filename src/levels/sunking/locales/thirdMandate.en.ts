...
export const messagesEnThirdMandate = {
  ...
  "level.successionWar.ending.victory":
    "When cannon-fire gives way to clauses, France does not inherit a cost-free map—but it does preserve dynastic continuity and the machinery of rule. In a war this long, ending with a governable state is itself a hard-won victory.\n\nPull back from the parchment, and Louis XIV’s lifetime casts a longer shadow than any single treaty. His reign consolidated an unusually centralized monarchy: standing armies, provincial intendants, and the choreography of Versailles turned scattered elites into a court-and-bureaucracy machine answerable to the crown. That machine projected power—and fear. From the Dutch wars to the League of Augsburg and the Nine Years’ War, neighbors learned a reflex: contain France before it becomes the only voice in the European chorus. Splendor had a ledger: decades of ambition habituated the treasury to borrowing, venal office, and wartime expedients, leaving the Spanish succession struggle to be paid in coin, credit, and political nerve. Religion threaded the same story: revoking the Edict of Nantes tightened Catholic discipline at the cost of exile, suspicion, and confessional scars that diplomats could not erase. The War of the Spanish Succession was the invoice for that system; surviving it with a credible crown is as much about institutions, memory, and narrative as about where the borders were drawn.",
  "level.successionWar.ending.victoryByTier.bourbon":
    "In the Bourbon-leaning tier, the treaty ledger bends your way—and in this route, you go beyond influence to formal union: the French and Spanish crowns are fused under one Bourbon dynastic order. Europe now faces a trans-Pyrenean, transoceanic Bourbon super-monarchy rather than a merely coordinated family bloc.\n\nYet the Sun King’s inheritance is not only triumph. Centralization outlived the man: the same administrative sinews that moved regiments and tax collectors also trained Europe to watch for French primacy. Fiscal strain does not vanish with peace; it hardens into debt service, tax pressure, and permanent borrowing. Your victory crowns two thrones at once, but it also plants the long fuse—social fracture, political backlash, and the revolutionary sparks of the next century.",
  "level.successionWar.ending.victoryByTier.compromise":
    "Historically aligned compromise: Utrecht–Rastatt–Baden does not crown a single hegemon. Philip V remains in Madrid, while renunciations, border adjustments, and maritime-commercial clauses prevent a Franco-Spanish union. Your ending is not continental domination, but a signed, enforceable balance.\n\nThat balance is itself the epitaph of Louis XIV’s world. His life’s work fused absolute monarchy with permanent mobilization: a stronger center, a jealous continent, and a fiscal engine that could dazzle at Versailles while groaning in the ledgers. Coalitions had learned to speak in unison against French overstretch; Utrecht wrote their vocabulary into law. Inside France, the religious politics of his age—unity imposed, minorities pushed out—left resentments that treaties could not launder. The compromise you hold is therefore doubly historical: it closes the succession war and confesses that no single crown, however brilliant, could reorder Europe without paying in guardrails, suspicion, and deferred debt.",
  "level.successionWar.ending.victoryByTier.habsburg":
    "In this tier, the Spanish succession is rewritten in favor of Charles VI of the House of Habsburg: Vienna turns dynastic legality into the backbone of settlement, while London and The Hague lock it in through coalition guarantees. For France, this is not merely a diplomatic setback but a structural downgrade—from shaping the succession outcome to absorbing it.\n\nFrance remains a great power, but now under two-front pressure: squeezed from the north by the Low Countries-Rhine security line and constrained from the south through Italy and the Iberian theater. You can still preserve core state capacity, yet every later move operates inside a tighter anti-French containment geometry built around Charles VI’s succession.",
  "level.successionWar.ending.victoryWarDevolutionExtra":
    "The War of Devolution still echoes in how cabinets price French initiative: neighbors remember early Bourbon offensives and build their alliances accordingly. Disciplined diplomacy in later chapters limits the worst spiral—but reputation, like debt, compounds across reigns.",
  "level.successionWar.ending.continuity.warOfDevolution.attacked":
    "Your first mandate chose the Devolution offensive, so the ending inherits a historical chain of suspicion. In 1716, Dutch and British pamphleteers reopen the memory of Aix-la-Chapelle to argue that Bourbon treaties need maritime guarantees, not trust; in the 1720s, Imperial engineers cite the old Low Countries shock when expanding Rhine and barrier-fortress plans; by the War of the Polish Succession, French claims in Lorraine are judged through the same precedent. The practical result is a Europe that treats even legal inheritance language as the opening move of annexation.",
  "level.successionWar.ending.continuity.warOfDevolution.restrained":
    "Your first mandate kept the Devolution crisis below open conquest, so this ending spins an alternate diplomatic afterlife. A 1716 Hague confidence protocol still watches French garrisons, but does not harden into a permanent anti-Bourbon alarm; a 1723 Brussels tariff congress lets France and the Dutch Republic bargain over frontier commerce instead of treating every customs dispute as a war warning; by the late 1720s, Vienna keeps its legal guard up but spends more attention on Italy and the Balkans than on an assumed French grab in the Low Countries. The result is not friendship, but a Europe where coalitions form later and with more argument.",
  "level.successionWar.ending.continuity.nantes.crackdown":
    "In the second mandate, you resolved Nantes through suppression, so the ending follows the harsher historical aftershocks. Refugee silk workers and financiers strengthen workshops in London, Amsterdam, Berlin, and Geneva; Camisard memories keep southern policing expensive into the 1710s; Protestant newspapers fold the Huguenot exile story into every new coalition appeal against Versailles. France gains a sharper tool of internal command, but its enemies gain people, capital, and a moral vocabulary that turns dynastic rivalry into a confessional cause.",
  "level.successionWar.ending.continuity.nantes.tolerance":
    "In the second mandate, you preserved a tolerant settlement around Nantes, so the ending moves into alternate history. A 1715 Council of Quiet Churches registers Protestant worship under royal inspectors instead of driving it fully underground; merchants from La Rochelle, Nimes, and Sedan keep more capital inside France and finance crown loans after the war; by the 1720s, Dutch and English polemicists have less refugee testimony to weaponize. The cost is domestic: bishops, Jesuit patrons, and hard-line parlements can still turn each renewal of toleration into a quarrel over whether obedience must mean uniformity.",
  "level.successionWar.ending.chapter3LouisXivLegacy.regencyCustody":
    "In 1715 you chose Regency custody. This route maps to a historical chain: in 1715 the Parlement of Paris curtailed parts of Louis XIV's will and confirmed the Orleans regency; in 1717 the Polysynody councils were launched to rewire top-level governance; in 1720, after the Mississippi bubble crash, fiscal policy shifted into emergency consolidation. The crown looks less theatrical, but state continuity is steadier.",
  "level.successionWar.ending.chapter3LouisXivLegacy.youngKingDirectRule":
    "In 1715 you chose Young king direct rule. This route follows a fictional chain: in 1716 the \"Versailles Dawn Edict\" puts war-and-finance councils under direct royal chairmanship; in 1717 the \"Frontier Audit Ordinance\" centralizes Rhine and Low Countries garrison control; in 1718 the \"Extraordinary Revenue Notes\" force rapid short-term borrowing. Command presence sharpens quickly, while fiscal and administrative strain compounds year after year.",
  ...
  "level.successionWar.ending.victorySuccessionTrackCap":
    "The contest of crowns ends in brilliance: Bourbon right and French grandeur, forged in testament, steel, and chancellery, stand as an unanswerable triumph. Philip of Anjou in Madrid is no longer a wager but a proclamation writ in sunlight—envy and leagues from the Channel to the Mediterranean must bend before your victory march. This is the Sun King’s hour at its zenith: the Spanish inheritance and the Bourbon diadem made one, and history will remember the day in gold.\n\nEven at this zenith, the lifetime behind the triumph whispers its conditions. Centralization gave France a voice no court could ignore; it also trained Europe to organize against that voice. Splendor and siege finance left a treasury that would keep waking to interest long after the trumpets faded. The confessional choices of the reign—Catholic unity, Protestant exile—survive in diplomatic distrust as much as in prayer. You have won the map of ambition; governing it is the slower war that outlasts any single king.",
  ...
  "log.utrechtPeaceSettlement.body.bourbon":
    "At signing your Bourbon claim already reads strong (track ≥ +5): the parchment tilts toward “Philip V stays in Madrid, swapped territories and guardrails prevent a Franco-Spanish union.” Historians usually tell this with Sicily, the Spanish Netherlands, Gibraltar, and American asiento clauses traded line by line; in this bracket the coalition ink yields a bit more—Bourbon Madrid is easier to defend at Versailles, while footnotes still recall how hungry the Sun King’s map once looked.",
  "log.utrechtPeaceSettlement.body.compromise":
    "Historical spine: between 1713 and 1715 the Utrecht, Rastatt, and Baden instruments moved the War of the Spanish Succession from winter quarters to clauses. Europe accepted Philip V’s Spain and its American system while renunciations, dynastic bans, and commercial articles ruled out the worst-case single crown; Britain took Gibraltar and pieces of the carrying trade, Savoy traded into Sicily, and the Dutch and imperial circuits bought enforceable guarantees on tariffs, garrisons, and Rhine corridors. Balance was not a slogan but a schedule of borders, customs houses, and convoys—what this chapter’s friendly Utrecht epilogue is tied to: neither a Bourbon maximal map nor a Grand Alliance eviction from Madrid.",
  ...
  "card.usurpationEdict.desc":
    "Succession track +2. Gain Edict Mobilization for 1 turn (next turn’s draw phase: draw 1 extra card) and Legitimacy Crisis for 2 turns (end of each turn: Legitimacy -1).",
  ...
  "card.habsburgRhineMagazineEmbargo.desc":
    "Opponent cost 1. Immediate: succession track −1; delayed: gain Supply Line Squeeze for 1 turn (next year your treasury-to-funding income is reduced by 1, not below 0).",
