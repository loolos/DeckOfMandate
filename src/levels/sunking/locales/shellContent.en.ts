...
export const sunkingShellContentEn = {
  ...
  "outcome.utrechtVictoryEpilogue.bourbon": "After the Utrecht settlement, open war gives way to parchment: in this alternate ending, Bourbon power does not stop at guardrails but formally unifies the French and Spanish crowns under one dynastic order. Europe confronts a far stronger double-crown monarchy—while mounting war costs, tax strain, and class tension begin laying the fuse for a future revolutionary age.",
