...
export const sunkingShellContentEn = {
  ...
  "outcome.successionCalendar1720Extra.bourbon": "By 1720, the settlements at Utrecht, Rastatt, and Baden have fixed the postwar terms: Philip V remains on the Spanish throne, a formal Franco-Spanish union is excluded, and the Spanish crown stays with a Bourbon branch. For France, the result preserves an outcome it can explain at home while acknowledging the concessions written into the treaties.",
