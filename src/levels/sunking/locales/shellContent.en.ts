...
export const sunkingShellContentEn = {
  ...
  "ui.dualFrontCrisis.concede": "Temporarily concede — succession track −3",
  "ui.dualFrontCrisis.escalate": "Expand the war — succession track +1, legitimacy −1, +3 Fiscal Burden",
  ...
  "ui.quickFrame.choice.nantes.crackdown": "Harsh Crackdown",
  "ui.quickFrame.choice.dualFront.concede": "Temporarily Concede",
  "ui.quickFrame.choice.dualFront.escalate": "Escalate War",
  "ui.quickFrame.choice.louisXiv.regency": "Regency Custody",
  "ui.quickFrame.choice.louisXiv.direct": "Young King Direct Rule",
  "ui.quickFrame.choice.localWar.attack": "Attack",
  "ui.quickFrame.choice.localWar.appease": "Appease",
  ...
  "ui.opponentEvent.piles": "Draw pile: {deck} · Discard pile: {discard}",
  ...
  "outcome.successionCalendar1720Extra.bourbon": "By 1720, open war has been closed by treaty, but the postwar settlement preserves the highest Bourbon outcome: Philip V holds the Spanish throne, and the French and Spanish crowns are brought into the same dynastic order. Europe now faces a double-crown Bourbon monarchy spanning the Pyrenees and linking Mediterranean power with the Atlantic colonial system, while Versailles can present the succession war as a victory that completed the dynastic union.",
  ...
  "log.effect.modEuropeAlertProgress": "Europe Alert progress {delta}",
  ...
  "log.eventLouisXivLegacy.regencyCustody": "[Turn {turn}] {event} — Regency custody chosen: this tracks the historical mainline after 1715. Under Orléans, government continues in the minor king's name, prioritizing fiscal credit, administrative continuity, and control over court factions after decades of war. It is less theatrical than direct royal assertion, but it preserves governability and buys the state time to recover before attempting a new cycle of ambition.",
  "log.eventLouisXivLegacy.youngKingDirectRule": "[Turn {turn}] {event} — Young king direct rule chosen: the crown moves early to project vigor and personal authority, seeking to re-center command around the monarch rather than a regency network. The political signal is powerful, and court discipline can tighten quickly; yet the price is steep, because maintaining prestige, military posture, and postwar obligations drives a much heavier fiscal burden into the years ahead.",
