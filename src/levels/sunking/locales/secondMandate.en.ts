...
export const messagesEnSecondMandate = {
  ...
  "event.nineYearsWar.desc":
    "From 1688, the Nine Years' War grew out of the League of Augsburg system into a continent-wide struggle over the European balance of power. Fighting stretched from the Rhineland and the Low Countries to maritime routes and colonial fronts, turning fiscal endurance into the core test of state capacity. In game terms, this is a Continued crisis: each turn you must pay floor(Europe Alert progress / 2) + 1 Funding to campaign (Intervention cannot be used), while delay risks legitimacy setbacks and ongoing fiscal drag.",
  ...
  "event.commercialExpansion.desc":
    "In late 17th-century France, Colbertist policy still backed manufactures, shipping, and chartered companies, but wartime strain and tariff friction kept expansion costly. Merchants request support for growth. Invest floor(Treasury/5)+1 Funding for Treasury +1.",
