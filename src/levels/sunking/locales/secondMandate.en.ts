...
export const messagesEnSecondMandate = {
  "level.gloryUnderStrain.name": "Sun King: Long Shadows at Noon",
  "level.gloryUnderStrain.introTitle": "France, 1676 — Hold the hegemony",
  "level.gloryUnderStrain.introBody":
    "France in 1676 appears dominant, but the monarchy is entering a high-pressure phase of rule. The Franco-Dutch War has not truly settled; frontier garrisons, fortress works, court expenditure, and accumulated debt are all draining the treasury at once. New taxation and requisitions, in turn, trigger resistance from parlements, provincial estates, and taxed communities. Versailles still projects grandeur, yet royal power is shifting from \"profiting by expansion\" to \"constantly paying to sustain hegemony.\"\n\nDomestic tensions are just as acute. Since the Edict of Nantes, France had relied on a limited confessional coexistence to preserve order; by Louis XIV's middle and later reign, the court increasingly tied religious uniformity to administrative obedience. Repression of Huguenots can display control in the short run, but it also risks talent flight, clandestine networks, and higher long-term policing costs. Leniency can reduce immediate violence, yet provoke backlash from hardliners in court and church. Tax pressure, grain crises, and confessional conflict reinforce one another, and any local breakdown can quickly escalate into a kingdom-wide legitimacy shock.\n\nExternal danger comes from the hardening balance-of-power coalition. Along the Low Countries arc, France lengthened garrisoned fortress corridors and routine frontier pressure toward the Spanish Netherlands and Dutch border belts; along the Rhine, crown jurists reworked Westphalian treaty clauses into seizures such as Strasbourg in 1681, embedding Bourbon bridgeheads deep inside imperial territory. Running parallel to campaigning armies was a quieter annexation machine: reunion chambers mined feudal archives and succession deeds to argue town after town already belonged to France, absorbing Alsace-related lordships without needing a continent-wide declaration of war—yet still shaving territory from the Reich and squeezing Dutch trade arteries.\n\nNeighboring monarchies drew the same lesson: bilateral concessions could not brake Bourbon enlargement; only coordinated containment could. The League of Augsburg formed in 1686; England, the Dutch Republic, and Spain drew tighter into alignment. After England's 1688 political rupture, anti-French coalition finance and maritime mobilization became far more durable, pushing the conflict from frontier friction into the Nine Years' War.\n\nAt the same time, the shadow of the Iberian succession is already visible: King Charles II of Spain has no surviving heir, his paternal line belongs to the Spanish Habsburgs, and his maternal ties run deeply into the French Bourbon house through repeated dynastic marriages. That leaves Madrid's succession question entangled with both Vienna and Versailles. For the Bourbons, claiming the Spanish crown promises a dynastic bloc linking France and Spain and a transformed strategic position in the Mediterranean and the Low Countries; for the Austrian Habsburgs, the Spanish crown is a legacy of their own wider family branch, and losing it to Bourbon control would mean facing stronger French pressure across Europe and overseas. This is why both camps treat the legal right to succeed in Spain as a non-negotiable core issue.\n\nYour challenge is not one campaign but a long war of attrition in which internal fragility and external encirclement deepen together: keep the center of rule intact between faith, taxation, dynastic succession, and war, and carry France through the coming full-scale confrontation.",
