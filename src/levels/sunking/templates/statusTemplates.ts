...
export const statusTemplates: Record<StatusTemplateId, StatusTemplate> = {
  ...
  customsSnarl: {
    ...
    kind: "drawAttemptsDelta",
    delta: -1,
    titleKey: "status.customsSnarl.name",
    historyKey: "status.customsSnarl.history",
    descKey: "status.customsSnarl.desc",
  },
  convoyDetention: {
    id: "convoyDetention",
    kind: "drawAttemptsDelta",
    delta: -1,
    titleKey: "status.convoyDetention.name",
    historyKey: "status.convoyDetention.history",
    descKey: "status.convoyDetention.desc",
  },
  warRequisition: {
    id: "warRequisition",
    kind: "beginYearFundingIncomeDelta",
    delta: -1,
    titleKey: "status.warRequisition.name",
    historyKey: "status.warRequisition.history",
    descKey: "status.warRequisition.desc",
  },
  supplyLineSqueeze: {
