...
export const cardTemplates: Record<CardTemplateId, CardTemplate> = {
  ...
  usurpationEdict: {
    ...
    effects: [
      { kind: "modSuccessionTrack", delta: 2 },
      { kind: "addPlayerStatus", templateId: "usurpationMobilization", turns: 1 },
  ...
  habsburgAngloDutchMaritimeInterdiction: {
    id: "habsburgAngloDutchMaritimeInterdiction",
    cost: 0,
    opponentCost: 1,
    tags: OPPONENT,
    titleKey: "card.habsburgAngloDutchMaritimeInterdiction.name",
    backgroundKey: "card.habsburgAngloDutchMaritimeInterdiction.background",
    descriptionKey: "card.habsburgAngloDutchMaritimeInterdiction.desc",
    effects: [],
  },
  habsburgRhineMagazineEmbargo: {
    id: "habsburgRhineMagazineEmbargo",
    cost: 0,
    opponentCost: 1,
    tags: OPPONENT,
    titleKey: "card.habsburgRhineMagazineEmbargo.name",
    backgroundKey: "card.habsburgRhineMagazineEmbargo.background",
    descriptionKey: "card.habsburgRhineMagazineEmbargo.desc",
    effects: [],
  },
};
