...
import { canApplyOpponentHandDiscardNow, enforceSuccessionImmediateOutcomeHook } from "./effectHooks";
import { shouldBlockModSuccessionTrackWhenWarEnded } from "./applyEffectsSuccessionGate";
